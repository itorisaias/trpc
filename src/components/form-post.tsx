...
export default function FormPost({ onSubmit }: FormProps) {
  ...
  const onSubmitForm: SubmitHandler<FormFields> = (payload) => {
    !!onSubmit && onSubmit({ action, payload });
  };
        ...
        <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
          <div>
            ...
            <div className="mt-1">
              <input
                type="text"
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm text-gray-800 focus:border-indigo-500 focus:ring-indigo-500"
                placeholder="title"
                {...register("title", {
            ...
            <div className="mt-1">
              <textarea
                ...
                {...register("content", {
                  maxLength: {
                    value: 3000,
                    message: 'Tamanho do conteudo não pode passar de 3000 caracteres.'
                  }
                })}
              ></textarea>
            </div>
            
            <span className="mt-2 text-sm text-gray-300 text-end">{contentLength}/3000</span>
